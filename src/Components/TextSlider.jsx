...
function TextSlider() {
    return (
      <Carousel interval={3000} controls={false} className="carouselW p-1">
        ...
        <Carousel.Item className="w-100">
          <p className="carouselText w-100">We create  stuff that makes a difference to the consumer</p>
        </Carousel.Item>
        <Carousel.Item className="w-100">
          <p className="carouselText w-100"> We create  stuff that makes a difference to the creative community</p>
        </Carousel.Item>
      </Carousel>
    );
  }
